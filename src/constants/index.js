...
const experiences = [
  {
    ...
    company_name: "AU IGNITE",
   icon: meta,
   iconBg: "#383E56 ",
    date: "Nov 2024 -Feb 2025 ",
    points: [
      "Gaining hands-on experience in front-end and back-end development using modern web technologies ",
       "Collaborating on real-world projects to strengthen technical and problem-solving skills",
      "Actively learning and applying best practices in clean coding, version control, and deployment."
    ],
  },
  // {
...
const projects = [
  {
    ...
    image: carrent,
    source_code_link: "https://github.com/krishanjangid777?tab=repositories",
  },
  {
    name: "Blog Website",
    description:
  ...
  {
    name: "ShriNeo-Vittiyam-",
    description:
      "A modern multilingual digital lending platform for borrowers and agents. Features loan applications, EMI tracking, agent commissions, WhatsApp support, and an AI assistant — all in one seamless UI.",
    tags: [
      {
        name: "JS",
        color: "blue-text-gradient",
